...
const cardsData = [
  ...
  {
    image: "src/public/assets/img2.jpg",
    content: "El Becerileri Etkinlikleri",
  },
  ...
  {
    image: "src/public/assets/img6.jpg",
    content: "Sağlık ve Gelişim Bilgileri",
  },
        ...
        <div id="backgroundC" className="text-center mx-auto p-5">
          <div className="row gx-lg-5">
            {cardsData.map((card, index) => (
              <div
                key={index}
                className="col-lg-6 col-xxl-4 mb-5 d-flex justify-content-center align-items-center"
              >
                <Card
